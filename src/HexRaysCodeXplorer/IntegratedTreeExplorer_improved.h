...
#ifndef INTEGRATED_TREE_EXPLORER_IMPROVED_H
#define INTEGRATED_TREE_EXPLORER_IMPROVED_H
...
public:
    ...
    qvector<inode_t> find_by_compiler(RTTIInfo::compiler_t compiler);
...
public:
    ...
    // Search operations
    VTableSearcher* get_searcher() { return searcher; }
...
#endif // INTEGRATED_TREE_EXPLORER_IMPROVED_H